      ...
      >
        <nav className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16 md:h-20">
          ...
          <div className="hidden md:flex items-center gap-6 ml-auto">
            <button aria-label="Locale" className="text-flow-300 hover:text-white transition-colors relative group" onClick={() => openPanel("locale")}>
              ...
              <span className="absolute -bottom-1 left-1/2 -translate-x-1/2 text-[8px] font-bold tracking-wider text-flow-400 group-hover:text-white transition-colors">
                {currency}
              </span>
            </button>
